    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <div>
                ...
                <x-input id="paterno" type="text" class="mt-1 block w-full" wire:model="state.paterno" required autocomplete="paterno" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <div>
                ...
                <x-input id="materno" type="text" class="mt-1 block w-full" wire:model="state.materno" required autocomplete="materno" />
